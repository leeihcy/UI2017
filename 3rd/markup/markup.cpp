...
bool CMarkup::FirstElem( MCD_CSTR szName )
{
	ResetMainPos();
	return NextElem(szName);
}

bool CMarkup::FirstChildElem( MCD_CSTR szName )
{
	ResetChildPos();
	return NextChildElem(szName);
}

bool CMarkup::NextElem( MCD_CSTR szName )
{
	if ( m_nDocFlags & MDF_WRITEFILE )
		return false;
...
bool CMarkup::NextChildElem( MCD_CSTR szName )
{
	if ( m_nDocFlags & (MDF_READFILE|MDF_WRITEFILE) )
		return false;
