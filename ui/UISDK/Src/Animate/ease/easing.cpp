...
AHFloat Easing(long/*EaseType*/ eType, AHFloat p)
{
    ...
    case UIA::ease_in_quad:
        return QuadraticEaseIn(p);
    case UIA::ease_out_quad:
        return QuadraticEaseOut(p);
    case UIA::ease_in_out_quad:
    ...
    case UIA::ease_in_out:
        return CubicEaseInOut(p);

    case UIA::ease_in_quart:
        return QuarticEaseIn(p);
    case UIA::ease_out_quart:
        return QuarticEaseOut(p);
    case UIA::ease_in_out_quart:
        return QuarticEaseInOut(p);

    case UIA::ease_in_quint:
        return QuinticEaseIn(p);
    case UIA::ease_out_quint:
        return QuinticEaseOut(p);
    case UIA::ease_in_out_quint:
        return QuinticEaseInOut(p);

    case UIA::ease_in_sine:
        return SineEaseIn(p);
    case UIA::ease_out_sine:
        return SineEaseOut(p);
    case UIA::ease_in_out_sine:
        return SineEaseInOut(p);

    case UIA::ease_in_circ:
        return CircularEaseIn(p);
    case UIA::ease_out_circ:
        return CircularEaseOut(p);
    case UIA::ease_in_out_circ:
        return CircularEaseInOut(p);
    
    case UIA::ease_in_expo:
        return ExponentialEaseIn(p);
    case UIA::ease_out_expo:
        return ExponentialEaseOut(p);
    case UIA::ease_in_out_expo:
        return ExponentialEaseInOut(p);

    case UIA::ease_in_back:
        return BackEaseIn(p);
    case UIA::ease_out_back:
        return BackEaseOut(p);
    case UIA::ease_in_out_back:
        return BackEaseInOut(p);

    case UIA::ease_in_elastic:
        return ElasticEaseIn(p);
    case UIA::ease_out_elastic:
        return ElasticEaseOut(p);
    case UIA::ease_in_out_elastic:
        return ElasticEaseInOut(p);

    case UIA::ease_in_bounce:
        return BounceEaseIn(p);
    case UIA::ease_out_bounce:
        return BounceEaseOut(p);
    case UIA::ease_in_out_bounce:
